...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Restaurant Management System");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 500, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Restaurant/UI/Icons/bg-login.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 500, 340));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Restaurant/UI/Icons/icons8_user_20px_1.png"))); // NOI18N
        ...
        disable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Restaurant/UI/Icons/icons8_invisible_20px_1.png"))); // NOI18N
        ...
        show.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Restaurant/UI/Icons/icons8_eye_20px_1.png"))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 420, 520));

        setSize(new java.awt.Dimension(917, 517));
...
//        userType = (String)jComboBox1.getSelectedItem();
        ...
        String user = new ConnectionFactory().checkLogin(username, password);
        if (user.equals("No")) {
            JOptionPane.showMessageDialog(null,"Invalid username or password.");
        }else if (user.equals("ADMIN")) {
            inTime = LocalDateTime.now();
            userDTO.setInTime(String.valueOf(inTime));
            Main m = new Main(username, userType, userDTO);
            m.setVisible(true);
            this.dispose();
        }else if (user.equals("CASHIER")) {
            inTime = LocalDateTime.now();
            userDTO.setInTime(String.valueOf(inTime));
            POS ps = new POS(username);
            ps.setVisible(true);
            this.dispose();
        }
    }
