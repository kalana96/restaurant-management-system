...
public class Form_Category extends javax.swing.JPanel {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (table.getSelectedRow()<0)
            ...
            if (txtCode.getText().equals("") || txtName.getText().equals(""))
                ...
                categoryDTO.setCatCode(txtCode.getText().trim());
                categoryDTO.setCategoryName(txtName.getText().trim());
                
                new CategoryDAO().editCategoryDAO(categoryDTO);
                loadDataSet();
                reset();
            }
        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (txtCode.getText().equals("") || txtName.getText().equals(""))
            ...
            new CategoryDAO().addCategoryDAO(categoryDTO);
            loadDataSet();
            reset();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (table.getSelectedRow()<0)
            ...
            if (opt==JOptionPane.YES_OPTION) {
                new CategoryDAO().deleteCategoryDAO(table.getValueAt(table.getSelectedRow(),0).toString());
                loadDataSet();
                reset();
            }
        }
...
//         new CategoryDAO().getCategoryDAO(catTable.getValueAt(catTable.getSelectedRow(),0).toString());
    ...
    private void loadDataSet() {
        try {
            ...
            table.setModel(categoryDAO.buildTableModel(categoryDAO.getQueryResult()));
    ...
    private void loadCode() {
        int lstNo = new GenarateCodeDAO().getCatCode();
        if (lstNo==0) {
            txtCode.setText("CAT-1");
        }else{
            lstNo++;
            txtCode.setText("CAT-"+lstNo);
        }
    }
}
