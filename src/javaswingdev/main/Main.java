...
import Restaurant.UI.login;
import java.awt.Component;
import javaswingdev.form.Form_Category;
import javaswingdev.form.Form_Dashboard;
import javaswingdev.form.Form_Expense;
import javaswingdev.form.Form_ExpenseReport;
import javaswingdev.form.Form_Item;
import javaswingdev.form.Form_Room;
import javaswingdev.form.Form_SaleReport;
import javaswingdev.form.Form_Table;
import javaswingdev.form.Form_User;
...
public class Main extends javax.swing.JFrame {
    ...
    public Main(String username, String userType, UserDTO userDTO) {
        initComponents();
...
//                    showForm(new Form_Table());
                    ...
                    showForm(new Form_Expense());
                }
                else if (index == 6 && indexSubMenu == 1) {
                    //Sales Report
                    showForm(new Form_SaleReport());
                } 
                else if (index == 6 && indexSubMenu == 2) {
                    //Expense Report
                    showForm(new Form_ExpenseReport());
                } 
