...
//        addTitle("");
        addTitle("COMPONENT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon. LIST, "Master Data", "Menu Category", "Menu Item", "Room", "Table"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SHOP , "GRN"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon. COLLECTIONS, "Wastage Entry"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon. BUSINESS, "Stock", "View Stock", "Stock Adjestment"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ACCOUNT_BALANCE, "Expenses"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PAYMENT, "Report", "Sales Report", "Expense Report"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON, "User Setting"));
//        addTitle("");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.EXIT_TO_APP, "Log Out"));
//        addTitle("COMPONENT");
...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ERROR_OUTLINE, "Error", "404", "500"));
    ...
    private JPanel createPanelMenu() {
        ...
        menuLayout = new MigLayout("wrap,fillx,inset 0,gapy 10", "[fill]");
